...
set label '{\Large 1000 $\times$ bigger than GaAs}' at 0.059,1.2
# set label '{\large Second harmonic generation $\chi$}'
...
p "data/up/res-nospin_0-2eV/shgL.vnl.sm_0.006_yxx_8452_40-nospin_scissor_0_Nc_27" u 1:(abso($2,$3,$4,$5)*1e-6) t '$|\chi^{yxx}|$' w l lw 3 lt 1 dt 1
