set terminal mp color solid latex magnification 1
...
set label "\\Large Injection current $\\mathbf{\\dot{J}}$ " at 0.1,7
...
set ylabel "{\\Large $\\eta^{yxy}$ [mC$^{3}$/J$^{2}$s$^{2}$]}"
# set yrange [-15:20]
set output "eta-up_y.mp"
p   "data/up/res-nospin_0-2eV/eta2.kk_xxy_yxy_zxy_8452_40-nospin_scissor_0_Nc_27"      u ($1-.004):($3*lm)  title "Total response" w l lt 1  lw 3,\
    "data/up/res-nospin_0-2eV/calEta2.kk_xxy_yxy_zxy_8452_2_40-nospin_scissor_0_Nc_27" u ($1-.004):(-$3*lm) title "Carbon contribution"     w l lt 7  lw 3,\
    "data/up/res-nospin_0-2eV/calEta2.kk_xxy_yxy_zxy_8452_1_40-nospin_scissor_0_Nc_27" u ($1-.004):(-$3*lm) title "Hydrogen contribution"     w l lt 2  lw 3,\
